...
Project.prototype.addScrollMagicScenesForHorizontalToSection = function () {
  this.itemEl
    .querySelectorAll(".blahlab-block-portfolio-item-image.vertical")
    .forEach(
...
Section.prototype.setupScrollMagicScenesForHorizontal = function () {
  this.el.querySelectorAll(".blahlab-block-team-members").forEach(
  ...
  this.el.querySelectorAll(".blahlab-block-picture").forEach(
  ...
  this.el.querySelectorAll(".blahlab-block-projects__project").forEach(
  ...
  this.el.querySelectorAll(".blahlab-block-blog-posts__post").forEach(
...
function init() {
  ...
  sectionElements.forEach(function (sectionElement, index) {
    ...
    if (section.el.querySelector(".blahlab-block-projects")) {
      ...
      section.el
        .querySelectorAll(".blahlab-block-projects__project")
